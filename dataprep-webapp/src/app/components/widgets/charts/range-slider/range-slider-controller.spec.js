        ...
        describe('#handleKey', () => {
            it('should validate on ENTER', () => {
                ...
                expect(ctrl.onBrushEnd).toHaveBeenCalledWith({
                    interval: { min: 12, max: 25, isMaxReached: false, excludeMax: true },
                });
            });
    ...
    describe('propagation', () => {
        describe('#onChange', () => {
            it('should propagate to parent component', () => {
                ...
                // then
                expect(ctrl.onBrushEnd).toHaveBeenCalledWith({
                    interval: { min: 12, max: 40, isMaxReached: true, excludeMax: false },
                });
            });
        });
        ...
        describe('#onInputChange', () => {
            ...
            it('should propagate change to parent component', () => {
                ...
                // then
                expect(ctrl.onBrushEnd).toHaveBeenCalledWith({
                    interval: { min: 10, max: 115, isMaxReached: true, excludeMax: false },
                });
            });
