...
import org.talend.dataprep.api.service.command.AsyncForwardCommand;
...
@Component
@Scope("request")
public class PreparationApply extends GenericCommand<Void> {
     ...
     */
    protected PreparationApply(String id, String version, ExportParameters.SourceType from) {
